                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-action mr-1" data-toggle="tooltip"
                                                                ...
                                                                onClick="editFunc('{{ $user->id }}')"><i
                                                                    class="fas fa-pencil-alt"></i></a>
                                                            <a class="btn btn-danger btn-action" id="getDeleteId"
                                                                data-toggle="tooltip" title="Delete"
                                                                onClick="deleteFunc('{{ $user->id }}')"><i
    ...
    <div class="modal fade" id="user-edit" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="javascript:void(0)" id="UserFormEdit" name="UserForm" class="form-horizontal"
                        ...
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">User Email</label>
                            <div class="col-sm-12">
                                <input type="email" class="form-control" id="emailtext" name="email"
                                    placeholder="Enter User Email" maxlength="50" required="">
                                <input type="hidden" class="form-control" id="passwordtext" name="password"
                                    placeholder="Enter User Email" maxlength="50" required="">
                            </div>
                        </div>
