...
<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">Manajemen Role</h2>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a class="btn btn-icon icon-left btn-primary" href="{{ route('role.create') }}">
                                <i class="fa fa-users" aria-hidden="true"></i>
                                Create New Role</a>
                            <a class="btn btn-icon icon-left btn-primary" href="/permission">
                                <i class="fa fa-users" aria-hidden="true"></i>
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="datatable" data-url="{{ route('role.filter') }}" data-destroy="{{ url('user') }}">
                                    <thead>
                                        <tr>
                                            <th>Level</th>
                                            <th>Action</th>
                        ...
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="datatable1" data-url="{{ route('role.filter1') }}" data-destroy="{{ url('user') }}">
                                    <thead>
                                        <tr>
                                            <th>Level</th>
                                            <th>Action</th>
