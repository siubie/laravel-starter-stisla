        ...
        <div class="card">
            <form action="{{ route('user.store') }}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <strong>Level:</strong>
                        {!! Form::select('roles[]', $roles,[], array('style'=> 'min-height: 120px;','name' => 'level','class' => 'form-control', 'multiple')) !!}
                    </div>
                    <div class="form-group">
                        <strong>Permission:</strong>
                        {!! Form::select('permission[]', $permission,[], array('style'=> 'min-height: 120px;','name' => 'permission','class' => 'form-control','multiple')) !!}
                    </div>
                </div>
